        ...
        {showForm && (
          <form onSubmit={handleSubmit} className="card" style={{ marginTop: "20px" }}>
            ...
            <div className="pricing-row">
              <input name="priceMonthly" type="number" placeholder="Monthly" value={formData.priceMonthly} onChange={handleChange} required />
              <input name="priceQuarterly" type="number" placeholder="Quarterly" value={formData.priceQuarterly} onChange={handleChange} required />
              <input name="priceYearly" type="number" placeholder="Yearly" value={formData.priceYearly} onChange={handleChange} required />
            </div>
